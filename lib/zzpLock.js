...
(function (win) {
    ...
    var PWD_SUCCESS = "success";
    var PWD_ERROR = "error";
    var SEC_SUCCESS = "storeSuccess";
    var SEC_ERROR = "storeError";
    var FIR_SHORT = "shortPwd";
    var FIR_REPEAT = "repeatPwd";
    ...
    var ZZPLock = function () {
        ...
        _createClass(ZZPLock, [{
            ...
            value: function pswWork() {
                var state = this.pswObj.lockState;
                if (state === 2) {
                    var lockPsw = this._pswEncript(JSON.stringify(this.pswObj.lockPsw)),
    ...
    var Util = {
         ...
         * @returns {boolean}
         */
        checkPsw: function checkPsw(p1, p2) {
            var p1str = '',
                p2str = '';
